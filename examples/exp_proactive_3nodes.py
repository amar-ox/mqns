...
# For LSYNC
t_slot = 10*(ch_1 + ch_2 + ch_3) / light_speed

# For SYNC
t_ext = 10*(ch_1 + ch_2 + ch_3) / light_speed
t_int = 10*(ch_1 + ch_2 + ch_3) / light_speed
...
topo_3_nodes = {
    "qnodes": [
        ...
        },
        {
            ...
            "apps": [LinkLayer(attempt_rate=1000, init_fidelity=init_fidelity), ProactiveRouting(ps=p_swap)]
        },
        {
            "name": "R2",
            "memory": {
